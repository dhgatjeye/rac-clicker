...
impl DelayProvider {
    ...
    pub fn update_post_mode(&mut self, post_mode: PostMode) {
        self.cached_post_mode = post_mode;
    }
    ...
    pub fn get_next_delay(&mut self) -> Duration {
        ...
        let final_delay = match self.cached_post_mode {
            PostMode::Bedwars => {
                final_delay
            }
            PostMode::Default => {
