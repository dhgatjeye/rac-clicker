...
impl DelayCalculator {
    pub fn new(pattern: ClickPattern, button: MouseButton, server_type: ServerType) -> crate::core::RacResult<Self> {
    ...
    pub fn next_delay(&mut self) -> Duration {
        ...
        let down_jitter = rng.random_range(-jitter_range..=jitter_range);
        ...
        if self.server_timing.use_combo_pattern() {
            ...
            if self.combo_counter == interval - 1 {
                ...
                let micro_pause = rng.random_range(min_pause..=max_pause);
